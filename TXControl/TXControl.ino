...
//  Serial.println(rawAccel.ZAxis);
  ...
  if(rawAccel.XAxis < -7000 && rawAccel.YAxis < 5999  && rawAccel.YAxis > -5999) //forward
  {
    //LED pins - Debug only
...
//    digitalWrite(pinD, LOW);
  ...
  else if(rawAccel.XAxis > 7000 && rawAccel.YAxis < 5999  && rawAccel.YAxis > -5999) //backward
  {
    //LED pins - Debug only
...
//    digitalWrite(pinD, HIGH);
  ...
  else if(rawAccel.YAxis > 6000 && rawAccel.XAxis < 6999 && rawAccel.XAxis > -6999)//right
  {
    //LED pins - Debug only
//    digitalWrite(pinA, LOW);
//    digitalWrite(pinB, LOW);
...
//    digitalWrite(pinD, HIGH);
  ...
  else if(rawAccel.YAxis < -6000 && rawAccel.XAxis < 5999 && rawAccel.XAxis > -2999)//left
  {
    //LED pins - Debug only
//    digitalWrite(pinA, HIGH);
//    digitalWrite(pinB, HIGH);
